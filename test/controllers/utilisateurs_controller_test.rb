...
class UtilisateursControllerTest < ActionController::TestCase
  ...
  test "should create utilisateur" do
    assert_difference('Utilisateur.count') do
      post :create, utilisateur: { code_postal: @utilisateur.code_postal, email: @utilisateur.email, nom: @utilisateur.nom, prenom: @utilisateur.prenom, rue: @utilisateur.rue, telephone: @utilisateur.telephone, ville: @utilisateur.ville }
    end
  ...
  test "should update utilisateur" do
    patch :update, id: @utilisateur, utilisateur: { code_postal: @utilisateur.code_postal, email: @utilisateur.email, nom: @utilisateur.nom, prenom: @utilisateur.prenom, rue: @utilisateur.rue, telephone: @utilisateur.telephone, ville: @utilisateur.ville }
    assert_redirected_to utilisateur_path(assigns(:utilisateur))
  end
